...
class VirtualcollectionsLayer(PloneSandboxLayer):
    """Layer to setup the virtualcollections site"""
    ...
    def setUpZope(self, app, configurationContext):
        """Set up the additional products required for the  site virtualcollections.
        ...
        # ----------------------------------------------------
        # Load our own virtualcollections
        # ----------------------------------------------------
        import virtualcollections
        self.loadZCML(
            'configure.zcml',
            package=virtualcollections
        )
    ...
    def setUpPloneSite(self, portal):
        ...
        self.applyProfile(portal, 'virtualcollections:default')


VIRTUALCOLLECTIONS_FIXTURE = VirtualcollectionsLayer(
    name='Virtualcollections:Fixture')


class IntegrationTesting(BIntegrationTesting):

    defaultBases = (
        VIRTUALCOLLECTIONS_FIXTURE,
...
VIRTUALCOLLECTIONS_INTEGRATION_TESTING = (
    IntegrationTesting(name="Virtualcollections:Integration")
)
...
VIRTUALCOLLECTIONS_FUNCTIONAL_TESTING = (
    FunctionalTesting(name="Virtualcollections:Functional")
)
...
VIRTUALCOLLECTIONS_SELENIUM_TESTING = (
    SeleniumTesting(name="Virtualcollections:Selenium")
)
...
VIRTUALCOLLECTIONS_SIMPLE = SimpleLayer(
    name='Virtualcollections:Simple'
)
...
class Browser(z2.Browser):  # pragma: no cover
    ...
    def __init__(self, app=None, url=None, headers=None):
        ...
        if not url.startswith('http'):
            host = VIRTUALCOLLECTIONS_FUNCTIONAL_TESTING['host']
            port = VIRTUALCOLLECTIONS_FUNCTIONAL_TESTING['port']
