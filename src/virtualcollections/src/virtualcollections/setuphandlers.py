...
from virtualcollections import PRODUCT_DEPENDENCIES

logger = logging.getLogger('virtualcollections / setuphandler')
...
def setupVarious(context):
    ...
    if context.readDataFile('virtualcollections_various.txt') is None:
        return
...
def setupQi(context):
    ...
    if context.readDataFile('virtualcollections_qi.txt') is None:
        return

    portal = context.getSite()
    portal_quickinstaller = getToolByName(portal, 'portal_quickinstaller')
    #portal_setup = getToolByName(portal, 'portal_setup')
    logger = logging.getLogger('virtualcollections.Install')
