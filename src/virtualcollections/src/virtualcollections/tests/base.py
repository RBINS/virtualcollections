...
from virtualcollections.testing import (
    PLONE_MANAGER_NAME,
    TEST_USER_NAME,
    VIRTUALCOLLECTIONS_SIMPLE as SIMPLE,
    VIRTUALCOLLECTIONS_FIXTURE as UNIT_TESTING,
    VIRTUALCOLLECTIONS_INTEGRATION_TESTING as INTEGRATION_TESTING,
    VIRTUALCOLLECTIONS_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING,
    VIRTUALCOLLECTIONS_SELENIUM_TESTING as SELENIUM_TESTING,
)
