...
from virtualcollections.setuphandlers import setup_catalog
from virtualcollections import upgrades
...
class FileVirtualcollectionsMigrator(BlobMigrator):
    src_portal_type = 'FileVirtualcollections'
    src_meta_type = 'FileVirtualcollections'
    dst_portal_type = 'FileVirtualcollections'
    dst_meta_type = 'FileVirtualcollections'


class Virtualcollections_migrate(grok.View):
    ...
    def custom_hook_blob(self):
        self.migrate_fileVirtualcollections_to_blob()
    ...
    def custom_hook_after_plone_upgrade(self):
        ...
        ps.runImportStepFromProfile(
            'profile-Virtualcollections.skin:default', "skins", run_dependencies=False)
